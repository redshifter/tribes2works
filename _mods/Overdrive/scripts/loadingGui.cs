...
function sendModInfoToClient(%client)
{
   ...
   messageClient(%client, 'MsgLoadQuoteLine', %snd, "<spush><font:sui generis:22><color:33CCCC><just:center>OVERDRIVE<spop>");
   messageClient(%client, 'MsgLoadQuoteLine', "", "");
   messageClient(%client, 'MsgLoadQuoteLine', "", "<spush><font:verdana bold:16><color:33CCCC>Version: <color:FFFFFF>" @ $asswhuppinVersion @ "<spop>");
   messageClient(%client, 'MsgLoadQuoteLine', "", "");
   messageClient(%client, 'MsgLoadQuoteLine', "", "<spush><font:verdana bold:16><color:33CCCC>Developer: <color:FFFFFF><a:PLAYER\tRed Shifter>Red Shifter</a><spop>");
   messageClient(%client, 'MsgLoadQuoteLine', "", "");
   messageClient(%client, 'MsgLoadQuoteLine', "", "<font:verdana bold:12><color:33CCCC>Based off Classic 1.5.2");
   messageClient(%client, 'MsgLoadQuoteLine', "", "");
   messageClient(%client, 'MsgLoadQuoteLine', "", "");
   messageClient(%client, 'MsgLoadQuoteLine', "", "");
   messageClient(%client, 'MsgLoadQuoteLine', "", "");
