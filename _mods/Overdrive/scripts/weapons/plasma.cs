...
// Overdrive Weapon
//--------------------------------------
datablock AudioProfile(PlasmaOverdriveFireSound)
{
...
datablock ItemData(PlasmaOverdrive)
{
   className = Weapon;
   catagory = "Spawn Items";
   shapeFile = "weapon_plasma.dts";
   image = PlasmaOverdriveImage;
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   pickupRadius = 2;
	pickUpName = "a plasma gun in overdrive";
};

datablock ShapeBaseImageData(PlasmaOverdriveImage)
{
   className = WeaponImage;
   shapeFile = "weapon_plasma.dts";
   item = PlasmaOverdrive;
   offset = "0 0 0";

   aura = AuraPlasma;

   projectileSpread = 18.0 / 1000.0;
...
//   stateAllowImageChange[3] = false;
   stateScript[3] = "onFire";
   stateEmitterTime[3] = 0.2;
   stateSound[3] = PlasmaOverdriveFireSound;
...
//   stateAllowImageChange[4] = false;
   ...
   stateName[8]               = "CheckWet";
   stateTransitionOnWet[8]    = "WetFire";
   stateTransitionOnNotWet[8] = "Fire1"; 

   stateName[9] = "Fire1";
   stateTransitionOnTimeout[9] = "Fire2";
   stateFire[9] = true;
...
//   stateAllowImageChange[10] = false;
   ...
   stateName[11] = "Fire3";
   stateTransitionOnTimeout[11] = "Fire4";
   stateFire[11] = true;
//   stateAllowImageChange[11] = false;
   stateScript[11] = "onFire";

   stateName[12] = "Fire4";
   stateTransitionOnTimeout[12] = "Fire5";
   stateFire[12] = true;
