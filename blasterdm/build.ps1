...
Compress-Archive -Path Readme.txt,missions,terrains,scripts -DestinationPath BlasterDMGameType.zip
ren BlasterDMGameType.zip BlasterDMGameType.vl2

del BlasterDM_Client.vl2
cd blasterdm_client
Compress-Archive -Path scripts -DestinationPath BlasterDM_Client.zip
