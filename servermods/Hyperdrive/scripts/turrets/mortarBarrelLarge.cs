...
datablock GrenadeProjectileData(MortarTurretShot)
{
   ...
   grenadeFriction   = 0.4;
   armingDelayMS     = 250; // z0dd - ZOD, 4/25/02. Was 2000
...
datablock TurretImageData(MortarBarrelLarge)
{
   ...
   // Turret parameters
   activationMS      = 100; // z0dd - ZOD, 7/13/02. Was 1000. Amount of time it takes turret to unfold
   deactivateDelayMS = 100; // z0dd - ZOD, 7/13/02. Was 1500. Amount of time before turret deactivates
   thinkTimeMS       = 50; // z0dd - ZOD, 7/13/02. Was 200. Amount of time before turret starts to unfold (activate)
   degPerSecTheta    = 580;
   degPerSecPhi      = 960;
