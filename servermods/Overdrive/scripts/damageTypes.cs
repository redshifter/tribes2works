...
datablock SimDataBlock(WildcatDamageProfile)
{
   ...
   shieldDamageScale[$DamageType::Mine] 			= 2.0; // z0dd - ZOD, 5/21/03. This is retarded, was 4.0
   ...
   damageScale[$DamageType::Mine] = 2.0; // z0dd - ZOD, 5/21/03. This is retarded, was 4.0
...
datablock SimDataBlock(TankDamageProfile)
{
   ...
   shieldDamageScale[$DamageType::Mine] = 2.75; // z0dd - ZOD, 5/21/03. This is retarded, was 3.25
   ...
   damageScale[$DamageType::Disc] = 1.0;
   damageScale[$DamageType::Grenade] = 1.0;
   damageScale[$DamageType::Mine] = 1.75; // z0dd - ZOD, 5/21/03. This is retarded, was 2.25
...
datablock SimDataBlock(MPBDamageProfile)
{
   ...
   shieldDamageScale[$DamageType::Disc] = 0.8;
   shieldDamageScale[$DamageType::Grenade] = 0.8;
   shieldDamageScale[$DamageType::Mine] = 3.0; // z0dd - ZOD, 5/21/03. Was 3.25
   shieldDamageScale[$DamageType::Missile] = 2.0;
   ...
   damageScale[$DamageType::Disc] = 1.0;
   damageScale[$DamageType::Grenade] = 1.0;
   damageScale[$DamageType::Mine] = 2.0; // z0dd - ZOD, 5/21/03. This is retarded, was 2.25
   damageScale[$DamageType::Missile] = 1.25;
   damageScale[$DamageType::Mortar] = 1.0;
   damageScale[$DamageType::Plasma] = 0.5;
   damageScale[$DamageType::BomberBombs] = 1.0;
...
datablock SimDataBlock(TurretDamageProfile)
{
   ...
   shieldDamageScale[$DamageType::Mine] = 2.5; // z0dd - ZOD, 5/21/03. This is retarded, was 3.0
   shieldDamageScale[$DamageType::Missile] = 3.0;
   ...
   damageScale[$DamageType::Grenade] = 1.0;
   damageScale[$DamageType::Mine] = 1.0; // z0dd - ZOD, 5/21/03. This is retarded, was 1.5
   damageScale[$DamageType::Missile] = 1.25;
...
datablock SimDataBlock(StaticShapeDamageProfile)
{
   ...
   shieldDamageScale[$DamageType::Mine] = 0.5; // z0dd - ZOD, 10/09/02. Was 2.0
   // z0dd - ZOD, 5/08/04. Less damage from missiles if gameplay changes in affect.
   shieldDamageScale[$DamageType::Missile] = $Host::ClassicLoadMissileChanges ? 1.0 : 3.0;
   shieldDamageScale[$DamageType::Mortar] = 3.0;
   ...
   damageScale[$DamageType::Mine] = 0.5; // z0dd - ZOD, 10/09/02. Was 2.0
   // z0dd - ZOD, 5/08/04. Less damage from missiles if gameplay changes in affect.
   damageScale[$DamageType::Missile] = $Host::ClassicLoadMissileChanges ? 1.15 : 2.0;
   damageScale[$DamageType::Mortar] = 2.0;
...
datablock SimDataBlock(LightPlayerDamageProfile)
{
   ...
   damageScale[$DamageType::PlasmaTurret] =		0.45; // z0dd - ZOD 3/30/02. was 1.0
...
datablock SimDataBlock(MediumPlayerDamageProfile)
{
   ...
   damageScale[$DamageType::MortarTurret] = 1.0;
   damageScale[$DamageType::PlasmaTurret] = 0.60; // z0dd - ZOD, 4/12/02. Was 0.65
   damageScale[$DamageType::SatchelCharge] = 3.0;
   damageScale[$DamageType::Default] = 1.0;
   damageScale[$DamageType::Impact] = 1.0;
   damageScale[$DamageType::Ground] = 1.0;
...
datablock SimDataBlock(HeavyPlayerDamageProfile)
{
   ...
   damageScale[$DamageType::SentryTurret] = 1.0;
   damageScale[$DamageType::Disc] = 0.60;
   damageScale[$DamageType::Grenade] = 0.8;
   damageScale[$DamageType::Mine] = 0.7; // z0dd - ZOD, 12/09/02. Was 0.8
   ...
   damageScale[$DamageType::PlasmaTurret] = 0.45; // z0dd - ZOD, 4/12/02. Was 0.4
   damageScale[$DamageType::SatchelCharge] = 3.0;
   damageScale[$DamageType::Default] = 1.0;
   damageScale[$DamageType::Impact] = 0.8;
   damageScale[$DamageType::Ground] = 1.0;
