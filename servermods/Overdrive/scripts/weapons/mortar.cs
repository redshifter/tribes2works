...
// Overdrive
//--------------------------------------
datablock ItemData(MortarOverdrive)
{
   className = Weapon;
   catagory = "Spawn Items";
   shapeFile = "weapon_mortar.dts";
   image = MortarOverdriveImage;
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   pickupRadius = 2;
	pickUpName = "a mortar gun in overdrive";

   computeCRC = false;
   emap = true;
};

datablock ShapeBaseImageData(MortarOverdriveImage)
{
   className = WeaponImage;
   shapeFile = "weapon_mortar.dts";
   item = MortarOverdrive;
   offset = "0 0 0";
   emap = true;

   aura = AuraMortar;

   projectileSpread = 50.0 / 1000.0;
