...
//   stateAllowImageChange[3]         = false;
   ...
   stateTimeoutValue[4]             = 0.15; // 0.25 load, 0.25 spinup
...
datablock AudioProfile(DiscOverdriveFireSound)
{
...
datablock ShapeBaseImageData(DiscOverdriveImage)
{
   className = WeaponImage;
   shapeFile = "weapon_disc.dts";
   item = DiscOverdrive;
...
//   stateAllowImageChange[3]         = false;
   stateSequence[3]                 = "Fire";
   stateScript[3]                   = "onFire";
   stateSound[3]                    = DiscOverdriveFireSound;

   stateName[4]                     = "Reload";
   stateTransitionOnNoAmmo[4]       = "NoAmmo";
   stateTransitionOnTimeout[4]      = "Ready";
   stateTimeoutValue[4]             = 0.10; // 0.25 load, 0.25 spinup
//   stateAllowImageChange[4]         = false;
   stateSequence[4]                 = "Reload";
   stateSound[4]                    = DiscReloadSound;
...
datablock ItemData(DiscOverdrive)
{
   className = Weapon;
   catagory = "Spawn Items";
   shapeFile = "weapon_disc.dts";
   image = DiscOverdriveImage;
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   pickupRadius = 2;
	pickUpName = "a spinfusor in overdrive";
   emap = true;
};
