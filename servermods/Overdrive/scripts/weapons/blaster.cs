...
datablock ShapeBaseImageData(BlasterOverdriveImage)
{
   className = WeaponImage;
   shapeFile = "weapon_energy.dts";
   item = BlasterOverdrive;
   projectile = EnergyBolt;
   projectileType = EnergyProjectile;
...
datablock ItemData(BlasterOverdrive)
{
   className = Weapon;
   catagory = "Spawn Items";
   shapeFile = "weapon_energy.dts";
   image = BlasterOverdriveImage;
   mass = 1;
   elasticity = 0.2;
   friction = 0.6;
   pickupRadius = 2;
	pickUpName = "a blaster in overdrive";
};