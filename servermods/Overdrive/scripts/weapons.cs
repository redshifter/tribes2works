...
$WeaponsHudData[18, bitmapName] = "gui/hud_blaster";
$WeaponsHudData[18, itemDataName] = "BlasterOverdrive";
$WeaponsHudData[18, reticle] = "gui/ret_blaster";
$WeaponsHudData[18, visible] = "true";

$WeaponsHudData[19, bitmapName] = "gui/hud_plasma";
$WeaponsHudData[19, itemDataName] = "PlasmaOverdrive";
$WeaponsHudData[19, reticle] = "gui/ret_plasma";
$WeaponsHudData[19, visible] = "true";

$WeaponsHudData[20, bitmapName] = "gui/hud_disc";
$WeaponsHudData[20, itemDataName] = "DiscOverdrive";
$WeaponsHudData[20, reticle] = "gui/ret_disc";
$WeaponsHudData[20, visible] = "true";

$WeaponsHudData[21, bitmapName] = "gui/hud_grenlaunch";
$WeaponsHudData[21, itemDataName] = "GrenadeLauncherOverdrive";
$WeaponsHudData[21, reticle] = "gui/ret_grenade";
$WeaponsHudData[21, visible] = "true";

$WeaponsHudData[22, bitmapName] = "gui/hud_mortor";
$WeaponsHudData[22, itemDataName] = "MortarOverdrive";
$WeaponsHudData[22, reticle] = "gui/ret_mortor";
$WeaponsHudData[22, visible] = "true";

$WeaponsHudData[23, bitmapName]   = "gui/hud_shocklance";
$WeaponsHudData[23, itemDataName] = "ShockLanceOverdrive";
...
$WeaponsHudData[24, itemDataName] = "superBlaster";
$WeaponsHudData[24, reticle] = "gui/ret_elf";
...
exec("scripts/weapons/superBlaster.cs");
...
function Weapon::onUse(%data, %obj)
{
   if(Game.weaponOnUse(%data, %obj))
      if (%obj.getDataBlock().className $= Armor) {
         if(%data.image.isTargetLaser) {
            %client = %obj.client;
            
            if( %client.laserColor $= "" )
               %client.laserColor = 5; //green
			
			if( %client.laserColor == 10 )
			   %obj.mountImage("TargetingLaserImage0" @ getRandom(1,6), $WeaponSlot); // rainbow
			else
			   %obj.mountImage("TargetingLaserImage" @ %client.laserColor, $WeaponSlot);
         }
         else     
